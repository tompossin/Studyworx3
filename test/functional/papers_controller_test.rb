...
class PapersControllerTest < ActionController::TestCase
  ...
  test "should create paper" do
    assert_difference('Paper.count') do
      post :create, paper: { body: @paper.body, published: @paper.published, synopsis: @paper.synopsis, title: @paper.title, user_id: @paper.user_id }
    end
  ...
  test "should update paper" do
    put :update, id: @paper, paper: { body: @paper.body, published: @paper.published, synopsis: @paper.synopsis, title: @paper.title, user_id: @paper.user_id }
    assert_redirected_to paper_path(assigns(:paper))
  end
